...
namespace Codebase.Mechanics.GuestSystem.GuestStates
{
    public class EvaluationState : GuestStateBase
    {
        ...
        {
            return served.targetStrength - STRENGTH_TOLERANCY <= moment.NeedTarget && 
                   moment.NeedTarget <= served.targetStrength + STRENGTH_TOLERANCY;
        }
        ...
        public override void Enter()
        {
            ...
            else
            {
                ...
                _guest.Loyalty -= 1;      // было _guest.Loyalty -= -1 (опечатка)
            }
